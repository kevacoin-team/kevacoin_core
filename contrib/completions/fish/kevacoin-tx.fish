...
# Extract options
function __fish_kevacoin_tx_get_options
...
# Extract commands
function __fish_kevacoin_tx_get_commands
...
complete \
    --command kevacoin-tx \
    --condition "not __fish_kevacoin_seen_cmd (__fish_kevacoin_tx_get_commands --commandsonly)" \
    --arguments "(__fish_kevacoin_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command kevacoin-tx \
    --arguments "(__fish_kevacoin_tx_get_commands)" \
    --no-files
