...
complete --command kevacoin-qt --no-files

# Extract options
function __fish_kevacoinqt_get_options
...
complete \
    --command kevacoin-qt \
    --arguments "(__fish_kevacoinqt_get_options --nofiles)"
