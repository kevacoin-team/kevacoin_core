...
complete --command kevacoind --no-files

# Extract options
function __fish_kevacoind_get_options
...
complete \
    --command kevacoind \
    --arguments "(__fish_kevacoind_get_options --nofiles)"
