...
signature file SHA256SUMS.asc from kevacointeam.org and kevacoin.org and
compares them.
...
HOST1 = "https://kevacointeam.org"
HOST2 = "https://kevacoin.org"
VERSIONPREFIX = "kevacoin-core-"
...
def verify_published_handler(args: argparse.Namespace) -> ReturnCode:
    WORKINGDIR = Path(tempfile.gettempdir()) / f"kevacoin_verify_binaries.{args.version}"
    ...
    # remove binaries that are known not to be hosted by kevacointeam.org
...
def main():
    ...
    pub_parser.add_argument(
        'version', type=str, help=(
            f'version of the kevacoin release to download; of the format '
    ...
    pub_parser.add_argument(
        ...
        help=(
            ...
            '(Sometimes kevacoin.org lags behind kevacointeam.org.)')
    )
