...
def main():
    ...
    bctester(os.path.join(env_conf["SRCDIR"], "test", "util", "data"), "kevacoin-util-test.json", env_conf)
...
def bctest(testDir, testObj, buildenv):
    ...
    if testObj["exec"] == "./kevacoin-util":
        execprog = os.getenv("KEVACOINUTIL", default=execprog)
    elif testObj["exec"] == "./kevacoin-tx":
        execprog = os.getenv("KEVACOINTX", default=execprog)
    ...
    if "error_txt" in testObj:
        ...
        # That stderr is empty if no errors are expected. However, kevacoin-tx
