...
from test_framework.test_framework import KevacoinTestFrameworkkkkk
...
class ScantxoutsetTest(KevacoinTestFrameworkkkkk):
    ...
    def run_test(self):
        ...
        # Note that all amounts in the UTXO set are powers of 2 multiplied by 0.001 KVA, so each amounts uniquely identifies a subset.
