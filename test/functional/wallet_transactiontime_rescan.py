...
class TransactionTimeRescanTest(KevacoinTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine KVA and create transactions
        ...
        # generate some kva to create transactions and check blockcount
        ...
        # send 10 kva to user's first watch-only address
        self.log.info('Send 10 kva to user')
        ...
        # send 5 kva to our second watch-only address
        self.log.info('Send 5 kva to user')
        ...
        # send 1 kva to our third watch-only address
        self.log.info('Send 1 kva to user')
