...
COIN = 100000000  # 1 kva in satoshis
MAX_MONEY = 1050000000 * COIN
...
# Objects that map to kevacoind objects, which can be serialized/deserialized
...
class CTransaction:
    ...
    def deserialize(self, f):
        ...
        if len(self.vin) == 0:
            ...
            # matches the implementation in kevacoind
            if (flags != 0):
                self.vin = deser_vector(f, CTxIn)
...
class msg_version:
    ...
    def deserialize(self, f):
        ...
        # But, unconditionally check it to match behaviour in kevacoind
...
class msg_headers:
    ...
    def deserialize(self, f):
        # comment in kevacoind indicates these should be deserialized as blocks
