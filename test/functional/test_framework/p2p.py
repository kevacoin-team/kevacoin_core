...
"""Test objects for interacting with a kevacoind node over the p2p protocol.

The P2PInterface objects interact with the kevacoind nodes under test using the
