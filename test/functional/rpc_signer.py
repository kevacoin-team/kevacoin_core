...
Verify that a kevacoind node can use an external signer command.
...
class RPCSignerTest(KevacoinTestFrameworkkk):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart kevacoind with -signer=<cmd>',
