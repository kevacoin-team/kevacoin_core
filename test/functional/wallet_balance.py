...
from test_framework.test_framework import KevacoinTestFrameworkkkk
...
class WalletTest(KevacoinTestFrameworkkkk):
    ...
    def run_test(self):
        ...
        # Send 40 KVA from 0 to 1 and 60 KVA from 1 to 0.
        ...
        # KVA, which is more than would be available if transaction 1 were
        # replaced.
