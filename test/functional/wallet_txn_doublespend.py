...
class TxnMallTest(KevacoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 KVA:
        ...
        # First: use raw transaction API to send 1240 KVA to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 KVA coin each
        ...
        # Node0's balance should be starting balance, plus 50KVA for another
        ...
        # Node0's total balance should be starting balance, plus 100KVA for
