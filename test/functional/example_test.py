...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the KevacoinTestFramework
    pass


class ExampleTest(KevacoinTestFramework):
    # Each functional test is a subclass of the KevacoinTestFramework class.
    ...
    def custom_method(self):
        ...
        KevacoinTestFramework class so other tests can use it."""
