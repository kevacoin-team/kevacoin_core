...
#ifndef KEVACOIN_INTERFACES_CHAIN_H
#define KEVACOIN_INTERFACES_CHAIN_H
...
//! internal workings of the kevacoin node, and not being very convenient to use.
...
#endif // KEVACOIN_INTERFACES_CHAIN_H
