...
#ifndef KEVACOIN_INTERFACES_NODE_H
#define KEVACOIN_INTERFACES_NODE_H
...
//! Top-level interface for a kevacoin node (kevacoind process).
class Node
{
public:
    virtual ~Node() {}
    ...
    //! Return setting value from <datadir>/settings.json or kevacoin.conf.
...
#endif // KEVACOIN_INTERFACES_NODE_H
