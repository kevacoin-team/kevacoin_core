...
#ifndef KEVACOIN_INTERFACES_INIT_H
#define KEVACOIN_INTERFACES_INIT_H
...
//! (kevacoin-gui, kevacoin-node, kevacoin-wallet, kevacoind, kevacoin-qt) and each
...
#endif // KEVACOIN_INTERFACES_INIT_H
