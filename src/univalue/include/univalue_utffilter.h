...
#ifndef KEVACOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
#define KEVACOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
...
#endif // KEVACOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
