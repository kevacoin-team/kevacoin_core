...
#ifndef KEVACOIN_CHAINPARAMSBASE_H
#define KEVACOIN_CHAINPARAMSBASE_H
...
/**
 * CBaseChainParams defines the base parameters (shared between kevacoin-cli and kevacoind)
...
#endif // KEVACOIN_CHAINPARAMSBASE_H
