...
#ifndef KEVACOIN_RPC_PROTOCOL_H
#define KEVACOIN_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in kevacoind
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< Kevacoin is not connected
