...
#ifndef KEVACOIN_RPC_UTIL_H
#define KEVACOIN_RPC_UTIL_H
...
/**
 * Parse a json number or string, denoting KVA/kvB, into a CFeeRate (sat/kvB).
 * Reject negative values or rates larger than 1KVA/kvB.
 */
