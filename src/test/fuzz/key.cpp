...
FUZZ_TARGET(key, .init = initialize_key)
{
...

    {
        ...
        assert(!tx_pubkey_script.IsPayToScriptHash(true));
        assert(!tx_pubkey_script.IsPayToWitnessScriptHash(true));
        ...
        assert(!tx_multisig_script.IsPayToScriptHash(true));
        assert(!tx_multisig_script.IsPayToWitnessScriptHash(true));
