...
#ifndef KEVACOIN_QT_GUIUTIL_H
#define KEVACOIN_QT_GUIUTIL_H
...
/** Utility functions used by the Kevacoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "kevacoin:" URI into recipient object, return true on successful parsing
