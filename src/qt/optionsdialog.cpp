      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->kevacoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->kevacoinAtStartup);
    ...
    ui->unit->setModel(new KevacoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->kevacoinAtStartup, OptionsModel::StartAtStartup);
