...
#ifndef KEVACOIN_QT_KEVACOINUNITS_H
#define KEVACOIN_QT_KEVACOINUNITS_H
...
/** Kevacoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class KevacoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit KevacoinUnits(QObject *parent);
