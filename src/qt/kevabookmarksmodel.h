...
#ifndef KEVACOIN_QT_KEVABOOKMARKSMODEL_H
#define KEVACOIN_QT_KEVABOOKMARKSMODEL_H
...
public:
    ...
    explicit KevaBookmarksModel(WalletModel *parent);
    ~KevaBookmarksModel();
...
#endif // KEVACOIN_QT_KEVABOOKMARKSMODEL_H
