...
#ifndef KEVACOIN_QT_KEVACOINAMOUNTFIELD_H
#define KEVACOIN_QT_KEVACOINAMOUNTFIELD_H
...
public:
    ...
    void setDisplayUnit(KevacoinUnit new_unit);
...
#endif // KEVACOIN_QT_KEVACOINAMOUNTFIELD_H
