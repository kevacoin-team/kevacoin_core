...
#ifndef KEVACOIN_QT_KEVACOINGUI_H
#define KEVACOIN_QT_KEVACOINGUI_H
...
public:
    ...
    explicit KevacoinGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~KevacoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a kevacoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, KevacoinUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(KevacoinUnit newUnits);
    /** Tells underlying optionsModel to update its current display unit. */
    void onMenuSelection(QAction* action);
};

#endif // KEVACOIN_QT_KEVACOINGUI_H
