...
{
    switch (unit) {
    case BitcoinUnit::KVA: return 0;
    case BitcoinUnit::mKVA: return 1;
    case BitcoinUnit::uKVA: return 2;
...
{
    switch (num) {
    case 0: return BitcoinUnit::KVA;
    case 1: return BitcoinUnit::mKVA;
    case 2: return BitcoinUnit::uKVA;
