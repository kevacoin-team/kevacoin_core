...
#ifndef KEVACOIN_IPC_CAPNP_COMMON_TYPES_H
#define KEVACOIN_IPC_CAPNP_COMMON_TYPES_H
...
//! Functions to serialize / deserialize common kevacoin types.
namespace mp {
...
#endif // KEVACOIN_IPC_CAPNP_COMMON_TYPES_H
