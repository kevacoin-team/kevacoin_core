...
#ifndef KEVACOIN_CONSENSUS_PARAMS_H
#define KEVACOIN_CONSENSUS_PARAMS_H
...
struct Params {
    ...
    /**
     * If true, witness commitments contain a payload equal to a Kevacoin Script solution
...
#endif // KEVACOIN_CONSENSUS_PARAMS_H
