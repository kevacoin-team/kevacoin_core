...
#ifndef KEVACOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define KEVACOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // KEVACOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
