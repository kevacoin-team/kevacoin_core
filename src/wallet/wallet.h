...
#ifndef KEVACOIN_WALLET_WALLET_H
#define KEVACOIN_WALLET_WALLET_H
...
public:
     ...
     * kevacoin-wallet tool code or by wallet migration code. If this is called
...
#endif // KEVACOIN_WALLET_WALLET_H
