...
#ifndef KEVACOIN_WALLET_WALLETUTIL_H
#define KEVACOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! kevacoin from opening the wallet, thinking it was newly created, and
...
#endif // KEVACOIN_WALLET_WALLETUTIL_H
