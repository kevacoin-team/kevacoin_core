...
#ifndef KEVACOIN_WALLET_TRANSACTION_H
#define KEVACOIN_WALLET_TRANSACTION_H
...
public:
     ...
     * on this kevacoin node, and set to 0 for transactions that were created
...
#endif // KEVACOIN_WALLET_TRANSACTION_H
