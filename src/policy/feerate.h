...
#ifndef KEVACOININ_POLICY_FEERATE_H
#define KEVACOININ_POLICY_FEERATE_H
...
const std::string CURRENCY_UNIT = "KVA"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    KVA_KVB,      //!< Use KVA/kvB fee rate unit
...
public:
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::KVA_KVB) const;
...
#endif // KEVACOININ_POLICY_FEERATE_H
