...
export CONTAINER_NAME=ci_native_nowallet_libkevacoinkernel
...
export GOAL="install"
export KEVACOIN_CONFIG="--enable-reduce-exports --enable-experimental-util-chainstate --with-experimental-kernel-lib --enable-shared"
